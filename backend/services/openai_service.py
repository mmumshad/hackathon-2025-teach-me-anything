...
class OpenAIService:
    ...
    async def generate_chat_response(
        ...
        try:
            ...
            system_prompt = self._build_system_prompt(grade_level)
    ...
    async def generate_quiz(
        ...
        """
        Generate 5 multiple choice quiz questions for a given topic
    ...
    def _build_system_prompt(self, grade_level: Optional[str] = None) -> str:
